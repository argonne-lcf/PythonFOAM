...
tmp<volScalarField> ML_One_Equation<BasicMomentumTransportModel>::chi() const
{
...
template<class BasicMomentumTransportModel>
tmp<volScalarField> ML_One_Equation<BasicMomentumTransportModel>::fv1
(
...
template<class BasicMomentumTransportModel>
tmp<volScalarField::Internal> ML_One_Equation<BasicMomentumTransportModel>::fv2
(
...
ML_One_Equation<BasicMomentumTransportModel>::Stilda
(
    const volScalarField::Internal& chi,
    const volScalarField::Internal& fv1
) const
...
template<class BasicMomentumTransportModel>
tmp<volScalarField::Internal> ML_One_Equation<BasicMomentumTransportModel>::fw
(
...
template<class BasicMomentumTransportModel>
void ML_One_Equation<BasicMomentumTransportModel>::correctNut
(
...
template<class BasicMomentumTransportModel>
ML_One_Equation<BasicMomentumTransportModel>::ML_One_Equation
(
...
template<class BasicMomentumTransportModel>
bool ML_One_Equation<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
tmp<volScalarField>
ML_One_Equation<BasicMomentumTransportModel>::DnuTildaEff() const
{
...
template<class BasicMomentumTransportModel>
tmp<volScalarField> ML_One_Equation<BasicMomentumTransportModel>::k() const
{
    return volScalarField::New
    (
        "k",
...
template<class BasicMomentumTransportModel>
tmp<volScalarField>
ML_One_Equation<BasicMomentumTransportModel>::epsilon() const
{
    WarningInFunction
...
template<class BasicMomentumTransportModel>
void ML_One_Equation<BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
