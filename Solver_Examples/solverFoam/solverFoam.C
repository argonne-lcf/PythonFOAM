...
int main(int argc, char *argv[])
{
    ...
    PyObject* my_func_args = PyTuple_New(2); // Tuple for arguments to my_func
    ...
    while (simple.loop(runTime))
    {
        ...
        while (simple.correctNonOrthogonal())
        {
            ...
            Info<< "Set array_2d as first argument of my_func_args tuple, and array_1d as second argument " << endl;
